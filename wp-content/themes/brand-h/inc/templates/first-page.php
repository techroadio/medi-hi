...
<article id="post-<?php the_ID();?>" <?php post_class();?>>
 ...
 <section class="text-justify">
	...
	<!-- Section1-1 (end) -->
    <!-- Section 2 (start) -->
<section class="mt-20 w-full text-center" style="background-color:#f2f3f5">
	<!-- Chart (start) -->
	<div class="chartsWrap text-justify">
		<div class="chart0 active lg:p-10 p-0 chart-1">
			<p class="pt-4 px-8 pt-8">
