...
function sunset_add_admin_page() {
	...
	add_menu_page( 'Sunset Theme Options', 'Brand H Theme', 'manage_options', 'alecaddd_sunset', 'sunset_theme_create_page', get_template_directory_uri() . '/img/sunset-icon.png', 99 );
